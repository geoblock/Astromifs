...
(*-----------------------------------------------------------------------*)
procedure MINI_SUN(T: Double; var RA, DEC: Double);
(*-----------------------------------------------------------------------*)
...
(*-----------------------------------------------------------------------*)
procedure T_FIT_SUN(TA, TB: Double; N: integer; var RA_POLY, DE_POLY, R_POLY: TPolynom);
...
var
  ...
  (*sub*)procedure PERTVEN; (* Keplerian terms and perturbations by Venus *)
  var
    I: integer;
  begin
    C[0] := 1.0;
  ...
  (*sub*)procedure PERTMOO; (* difference between the Earth-Moon *)
