...
{$APPTYPE CONSOLE}
  ...
  var   T_begin,T_END,T1,T2,TM,T_EQX,T_EPOCH : Double;
        ETDIFUT                              : Double;
...
(*          proper motion                                                *)
(*-----------------------------------------------------------------------*)
procedure GETSTAR ( T_EPOCH,T: Double;
                    var RA,DEC: Double; var NAME: NAME_STRING);
  var G,M,I            :  Integer;
...
procedure CONJUNCT ( TA,TB: Double; RAPOLY,DEPOLY,RPOLY: TPolynom;
                     RA,DEC: Double; var CONJ: Boolean; var T_CONJ: Double);

  const EPS=1E-3; (* accuracy in degrees RA *)

  var RA_A,RA_B                    : Double;
...
procedure SHADOW
  ...
  ( RAPOLY, DEPOLY, RPOLY                                  : TPolynom;
    T_CONJ_ET,ETDIFUT, LAMBDA,RCPHI,RSPHI,  RA_STAR,DE_STAR: Double;
    var EVENT                                              : Boolean;
    var MJD_UT_IN, MJD_UT_OUT                              : Double;
  ...
  procedure FG ( HOUR: Double; var F,G: Double);
    var T,DEM,RM,RCDEM,RSDEM,DRAM,DRA: Double;
    begin
  ...
  procedure CONTACT ( HOUR: Double; var POS,H,A,B: Double);
    var F,G,FF,GG,DF,DG,FAC,DRA,CDRA,SDRA: Double;
    begin
...
function DARKNESS ( MODJD, LAMBDA,CPHI,SPHI: Double): Boolean;
  var T,RA,DEC,TAU,SIN_HSUN: Double;
  begin
...
procedure EXAMINE ( T1,T2: Double; RAPOLY,DEPOLY,RPOLY: TPolynom;
                    ETDIFUT,LAMBDA,RCPHI,RSPHI,RA_STAR,DE_STAR: Double;
                    NAME: NAME_STRING);
