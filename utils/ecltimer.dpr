...
procedure BESSEL ( T_UT, ETDIFUT   :  Double;
                   POLYEPH         :  TPOLYEPH;
                   var IJK         :  MAT3X;
                   var XSH,YSH     :  Double;
                   var F1,L1,F2,L2 :  Double       );

  var T_ET, DIST, ZSH         : Double;
...
procedure OBSERVER ( T_UT                    : Double;
                     LAMBDA, RCOSPHI, RSINPHI: Double;
                     IJK                     : MAT3X;
...
procedure CONTACTS ( T_NEWMOON, ETDIFUT    : Double;
                     LAMBDA,RCOSPHI,RSINPHI: Double;
                     POLYEPH               : TPOLYEPH;
                     var CONTACT_TIMES     : REAL4;
                     var T_MAX,MAG,OBSCUR  : Double;
...
procedure POS_ANGLES ( ETDIFUT               : Double;
                       LAMBDA,RCOSPHI,RSINPHI: Double;
                       POLYEPH               : TPOLYEPH;
                       CONTACT_TIMES         : REAL4;
                       PHASE                 : PHASE_TYPE;
